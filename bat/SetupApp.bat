...
:: Android packaging
set AND_CERT_NAME="Starling-Dynamic-Lightning-Test"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\Starling-Dynamic-Lightning-Test.p12
...
set IOS_PROVISION=cert\Starling-Dynamic-Lightning-Test.mobileprovision
...
:: Output packages
set DIST_PATH=dist
set DIST_NAME=Starling-Dynamic-Lightning-Test
